  ...
  <IonPage>
    ...
    <IonPage class="data-opacity" :class="{ showopacity: !isLoading }">
      <IonContent class="custom-scrollbar">
        ...
        <div
          class="flexcenter"
          style="border-top: 1px solid lightgrey; margin-top: 30px"
        >
          <IonText style="font-family: BebasNeue-Regular; font-size: 40px">
            Classifications
          </IonText>
...
export default {
  ...
  setup() {
    ...
    onMounted(async () => {
      ...
      for (const successday of dsuccess) {
        const successInDay = swipesuccess.value.filter((success) => {
          if (success.latestDateCreated) {
            ...
            const successDay = date.toLocaleString("default", {
              weekday: "long",
            });
      ...
      const canvassuccessd = document.getElementById(
        "successd"
      ...
      for (const successmonth of msuccess) {
        const successInMonth = swipesuccess.value.filter((success) => {
          if (success.latestDateCreated) {
            const date = new Date(success.latestDateCreated);
            const successMonth = date.toLocaleString("default", {
              month: "long",
            });
      ...
      const canvassuccessm = document.getElementById(
        "successm"
      ) as HTMLCanvasElement;
      if (canvassuccessm) {
      ...
      for (const successyear of ysuccess) {
        const successInYear = swipesuccess.value.filter((success) => {
          if (success.latestDateCreated) {
            const date = new Date(success.latestDateCreated);
            const successYear = date.toLocaleString("default", {
              year: "numeric",
            });
      ...
      const canvassuccessy = document.getElementById(
        "successy"
      ) as HTMLCanvasElement;
      if (canvassuccessy) {
      ...
      jobPostings.value.filter((job) => {
        if (job.classification == "Accounting") {
          ...
          job.classification == "Information & Communication Technology"
        ) {
          return x18.value++;
          ...
          job.classification == "Manufacturing, Transport & Logistics"
        ) {
          return x21.value++;
      ...
      jobPostings.value.filter((job) => {
        ...
        if (job.subclassification == "Accounts Officers/Clerks") {
          ...
          job.subclassification == "Accounts Receivable/Credit Control"
        ) {
          return y3.value++;
          ...
          job.subclassification == "Bookkeeping & Small Practice Accounting"
        ) {
          return y9.value++;
        } else if (
          job.subclassification == "Business Services & Corporate Advisory"
        ) {
          return y10.value++;
          ...
          job.subclassification == "Financial Accounting & Reporting"
        ) {
          return y14.value++;
        } else if (
          job.subclassification == "Financial Managers & Controllers"
        ) {
          return y15.value++;
        } else if (
          job.subclassification == "Forensic Accounting & Investigation"
        ) {
          return y16.value++;
          ...
          job.subclassification == "Management Accounting & Budgeting"
        ) {
          return y20.value++;
          ...
          job.subclassification == "Record Management & Document Control"
        ) {
          return y33.value++;
          ...
          job.subclassification == "Media Strategy, Planning & Buying"
        ) {
          return y39.value++;
          ...
          job.subclassification == "Account & Relationship Management"
        ) {
          return y44.value++;
        } else if (job.subclassification == "Banking - Business") {
          return y46.value++;
        } else if (
          job.subclassification == "Banking - Corporate & Institutional"
        ) {
          return y47.value++;
          ...
          job.subclassification == "Corporate Finance & Investment Banking"
        ) {
          return y51.value++;
          ...
          job.subclassification == "Customer Service - Customer Facing"
        ) {
          return y59.value++;
          ...
          job.subclassification == "Child Welfare, Youth & Family Services"
        ) {
          return y69.value++;
          ...
          job.subclassification == "Indigenous & Multicultural Services"
        ) {
          return y74.value++;
        } else if (
          job.subclassification == "Volunteer Coordination & Support"
        ) {
          return y75.value++;
          ...
          job.subclassification == "Environment & Sustainability Consulting"
        ) {
          return y86.value++;
          ...
          job.subclassification == "Childcare & Outside School Hours Care"
        ) {
          return y99.value++;
        } else if (
          job.subclassification == "Library Services & Information Management"
        ) {
          return y100.value++;
          ...
          job.subclassification == "Veterinary Services & Animal Welfare"
        ) {
          return y135.value++;
          ...
          job.subclassification == "Natural Therapies & Alternative Medicine"
        ) {
          return y154.value++;
        } else if (
          job.subclassification == "Nursing - A&E, Critical Care & ICU"
        ) {
          return y155.value++;
          ...
          job.subclassification == "Nursing - Community Maternal & Child Health"
        ) {
          return y158.value++;
        } else if (
          job.subclassification == "Nursing - Educators & Facilitators"
        ) {
          return y159.value++;
        } else if (
          job.subclassification == "Nursing - General Medical & Surgical"
        ) {
          return y160.value++;
          ...
          job.subclassification == "Nursing - Midwifery, Neo-Natal, SCN & NICU"
        ) {
          return y163.value++;
          ...
          job.subclassification == "Pharmaceuticals & Medical Devices"
        ) {
          return y169.value++;
        } else if (job.subclassification == "Pharmacy") {
          return y170.value++;
        } else if (
          job.subclassification == "Physiotherapy, OT & Rehabilitation"
        ) {
          return y171.value++;
        } else if (
          job.subclassification == "Psychology, Counseling & Social Work"
        ) {
          return y172.value++;
          ...
          job.subclassification == "Database Development & Administration"
        ) {
          return y199.value++;
          ...
          job.subclassification == "Networks & Systems Administration"
        ) {
          return y205.value++;
        } else if (
          job.subclassification == "Product Management & Development"
        ) {
          return y206.value++;
          ...
          job.subclassification == "Industrial Relations & Employment Law"
        ) {
          return y230.value++;
          ...
          job.subclassification == "Couriers, Drivers & Postal Services"
        ) {
          return y242.value++;
          ...
          job.subclassification == "Pattern Makers & Garment Technicians"
        ) {
          return y247.value++;
        } else if (job.subclassification == "Pickers & Packers") {
          return y248.value++;
        } else if (
          job.subclassification == "Production, Planning, & Scheduling"
        ) {
          return y249.value++;
        } else if (
          job.subclassification == "Public Transport & Taxi Services"
        ) {
          return y250.value++;
        } else if (
          job.subclassification == "Purchasing, Procurement & Inventory"
        ) {
          return y251.value++;
        } else if (job.subclassification == "Quality Assurance & Control") {
          return y252.value++;
          ...
          job.subclassification == "Warehousing, Storage & Distribution"
        ) {
          return y256.value++;
          ...
          job.subclassification == "Marketing Assistants/Coordinators"
        ) {
          return y263.value++;
          ...
          job.subclassification == "Public Relations & Corporate Affairs"
        ) {
          return y266.value++;
          ...
          job.subclassification == "Mining - Engineering & Maintenance"
        ) {
          return y271.value++;
        } else if (
          job.subclassification == "Mining - Exploration & Geoscience"
        ) {
          return y272.value++;
          ...
          job.subclassification == "Oil & Gas - Engineering & Maintenance"
        ) {
          return y277.value++;
        } else if (
          job.subclassification == "Oil & Gas - Explorations & Geoscience"
        ) {
          return y278.value++;
        } else if (job.subclassification == "Oil & Gas - Operations") {
          return y279.value++;
        } else if (
          job.subclassification == "Oil & Gas - Production & Refinement"
        ) {
          return y280.value++;
          ...
          job.subclassification == "Body Corporate & Facilities Management"
        ) {
          return y285.value++;
        } else if (
          job.subclassification == "Commercial Sales, Leasing & Property Mgmt"
        ) {
          return y286.value++;
        } else if (
          job.subclassification == "Residential Leasing & Property Management"
        ) {
          return y287.value++;
          ...
          job.subclassification == "Management - Department/Assistant"
        ) {
          return y293.value++;
          ...
          job.subclassification == "Sales Representatives/Consultants"
        ) {
          return y302.value++;
        } else if (
          job.subclassification == "Biological & Biomedical Sciences"
        ) {
          return y303.value++;
          ...
          job.subclassification == "Environmental, Earth & Geosciences"
        ) {
          return y306.value++;
          ...
          job.subclassification == "Air Conditioning & Refrigeration"
        ) {
          return y315.value++;
          ...
          job.subclassification == "Maintenance & Handyperson Services"
        ) {
          return y329.value++;
