<template>
    ...
    <div style="height: 100%;">
        <IonContent class="custom-scrollbar">
            <div class="admin-manageuser-cards-container">
                <IonCard @click="viewuserModal(true, user.id)" v-for="user in filteredSearch" class="admin-user-cards">
    ...
    <viewUser :pass-id="passID" :is-viewmodal="isviewUser" @did-dismiss="viewuserModal(false, '')" ></viewUser>
